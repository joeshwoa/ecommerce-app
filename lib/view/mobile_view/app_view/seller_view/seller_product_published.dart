...
class SellerProductPublished extends StatefulWidget {
  const SellerProductPublished({super.key});

  @override
  State<SellerProductPublished> createState() => _SellerProductPublishedState();
}

class _SellerProductPublishedState extends State<SellerProductPublished> {
  @override
