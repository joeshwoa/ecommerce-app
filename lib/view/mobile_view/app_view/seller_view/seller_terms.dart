...
class _SellerTermsState extends State<SellerTerms> {
  ...
  void initState() {
    ...
    if(!isLoading)
    {
      ...
      get(ApiPaths.getSellerTerms).then((value){
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: AppColors.mainColor,
          centerTitle: true,
          title: AppText('سياسات الاستخدام للتاجر',size: MAsizes.textNormalSize, color: AppColors.textWhiteColor),
          leading: IconButton(
            onPressed: (){
