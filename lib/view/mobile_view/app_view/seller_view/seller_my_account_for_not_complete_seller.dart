...
class SellerMyAccountForNotCompleteSeller extends StatelessWidget {
  const SellerMyAccountForNotCompleteSeller({super.key});
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    AppText('تاجر بدون متجر', size: MAsizes.textNormalSize, color: AppColors.textGreenColor),
