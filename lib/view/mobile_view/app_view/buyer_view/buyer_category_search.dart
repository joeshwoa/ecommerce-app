...
class BuyerCategorySearch extends StatefulWidget {
  const BuyerCategorySearch({super.key,required this.cubit});
  final BuyerLayoutCubit cubit;

  @override
  State<BuyerCategorySearch> createState() => _BuyerCategorySearchState();
}

class _BuyerCategorySearchState extends State<BuyerCategorySearch> {
  ...
  Future<void> fetchData() async {
    ...
    if (!isLoading) {
      ...
      final responseMap = await post(ApiPaths.categorySearch+page.toString(),data).onError((error, stackTrace) {
        return {
          'code':999
        };
      });
        ...
        body: CustomScrollView(
          ...
          *//*shrinkWrap: true,*//*
          ...
          slivers: <Widget>[
            SliverAppBar(
              centerTitle: true,
              /*collapsedHeight: MAsizes.buttonHeight,*/
              backgroundColor: Colors.white60,
              /*toolbarHeight: MAsizes.buttonHeight,*/
            ...
            SliverGrid.builder(
              gridDelegate:
              SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: !isLoading && categories.isEmpty?1:2),
              ...
              itemBuilder: (context, index) {
                if(!isLoading && categories.isEmpty) {
                  ...
                  child: Column(
                    ...
                    children: [
                      AppText('قم بكتابة اسم الفئات',color: AppColors.textGreenColor,size: MAsizes.textBigSize),
