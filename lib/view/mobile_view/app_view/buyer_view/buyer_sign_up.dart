                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppText('تسجيل العميل',size: MAsizes.textBetweenNormalAndBigSize,color: AppColors.textGreenColor,),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                    onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => const BuyerPolicy(),));
                                    },
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextButton(
                                    onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => const BuyerTerms(),));
                                    },
                          ...
                          MaterialButton(
                            onPressed: () async {
                              if(formKey.currentState!.validate()&&acceptPolicy&&acceptTerms)
                              {
                                ...
                                Map responseMap = await post(ApiPaths.buyerSignUp,data).onError((error, stackTrace) {
                                  return {
                                    'code':999
                                  };
                                });
                                if((responseMap['code']>=200 && responseMap['code']<300)){
                                  ...
                                  if (context.mounted){
                                    ...
                                    Timer(const Duration(seconds: 1), () {
                                      ScaffoldMessenger.of(context).clearSnackBars();
                                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MAAccountCreated(userType: 'buyer')));
                                    });
                                  }
                                  ...
                                  for(int i = 0;i<responseMap['body']['errors'].length;i++){
                                    if(responseMap['body']['errors'][i]['msg'] == 'E-mail already in user') {
                                      if (context.mounted){
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
