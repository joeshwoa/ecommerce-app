...
import 'package:klnakhadem/view/mobile_view/app_view/buyer_view/buyer_phone_login.dart';
...
class BuyerEmailLogin extends StatefulWidget {
  const BuyerEmailLogin({super.key});

  @override
  State<BuyerEmailLogin> createState() => _BuyerEmailLoginState();
}

class _BuyerEmailLoginState extends State<BuyerEmailLogin> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          MaterialButton(
                            onPressed: () async {
                              if(formKey.currentState!.validate())
                              {
                                ...
                                Map responseMap = await post(ApiPaths.buyerLogIn,data);
                          ...
                          MaterialButton(
                            onPressed: (){
                              Navigator.pop(context);
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const BuyerPhoneLogin()));
                            },
                            child: Container(
                                height: MAsizes.buttonHeight,
