...
class MAsellerMoneyTransformationBox extends StatelessWidget {
  const MAsellerMoneyTransformationBox({super.key,required this.year,required this.month,required this.day,required this.money,required this.plus});
  final int year;
  final int month;
  final int day;
  final double money;
